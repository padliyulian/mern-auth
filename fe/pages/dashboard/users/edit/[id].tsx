...
interface EditUserProps extends WithRouterProps {
}
...
class EditUser extends React.Component<EditUserProps> {
    ...
    handleLoad = () => {
        ...
        axios.get(`/auth/users/${this.props.router.query.id}`)
            .then(res => {
    ...
    handleSave = (e: any) => {
        ...
        axios.patch(`/auth/users/${this.props.router.query.id}`, formData)
            .then(res => {
                if (res.data.status === 'success') {
                    this.handleClear()
                    this.handleReset()
                                    ...
                                    <div className="card-body">             
                                        <form action="/auth/users" method="POST" encType="multipart/form-data">
                                            <div className="row">
                                                ...
                                                <div className="form-group col-lg-12">
                                                    <button onClick={this.handleSave} type="submit" className="btn btn-primary">Update</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
