...
interface CreatePermissionProps extends WithRouterProps {
}

class CreatePermission extends React.Component<CreatePermissionProps> {
    state = {
        name: '',
        guardName: '',
    ...
    handleSave = (e: { preventDefault: () => void }) => {
        ...
        axios.post(`/auth/permissions`, this.state)
            .then(res => {
...
export default withRouter(CreatePermission)